...
if pop count is same as number of course, return list of course taken. Save all the pop list in the result array
"""
...
class Solution:
    def canFinish(self, numCourses: int, prerequisites: List[List[int]]) -> bool:
        ...
        return courses if course_taken == numCourses else []
